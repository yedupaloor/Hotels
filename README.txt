...
in {root}\Tcs.Nitin\Tcs.Nitin.Web\index.html

This project uses SQLExpress2014. Change connection string in {root}\Tcs.Nitin\Tcs.Nitin.Core\App.config line 18.
...
Change connection string in {root}\Tcs.Nitin\Tcs.Nitin.Api\Web.config line 79 with the new connection string.

Host in IIS

Create two web sites in IIS. One for web api and one for angular. 

Note the hostname for web api project and replace the hostname with the current hostname in {root}\Tcs.Nitin\Tcs.Nitin.Web\scripts\FromWebApi.js file, line 3 as 
